    ...
    export default {
        data() {
            return {
                ...
                checkedCities: ['区域', '省份', '城市', '日期', '时间', '位置', '位置2', '产品名称', '文案', '广告截图', '链接1地址', '链接1页面', '链接2地址', '来源', '归属'],
                cities: [ '日期', '时间','区域', '省份', '城市', '位置', '位置2', '产品名称', '文案', '广告截图', '链接1地址', '链接1页面', '链接2地址', '来源', '归属'],
                table_column: [
                    {
                        fixed: true,
                        prop: 'date',
