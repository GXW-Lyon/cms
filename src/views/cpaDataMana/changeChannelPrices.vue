...
<template>
            ...
            <div class="info_ad_search">
                <div class="info_a_s_content">
                    <div class="customerProCitySearch">
                        ...
                        <el-button class="page_d_s_button" @click="pageInfo" style="float: right;margin-right:0;">查询</el-button>
                        <div class="dateBut" style="margin-top:4px;">
    ...
    <el-button type="primary" @click="dialogVisible = false" style="height:auto;">取 消</el-button>
    ...
    export default {
        data() {
            return {
                ...
                loading: false,
                checkAll: true,
                checkedCities: ['客户名称', '产品名称','上游渠道号', '价格',],
                cities: ['客户名称', '产品名称','上游渠道号', '价格',],
                table_column: [
                    ...
                    {fixed: false, prop: 'packageName', label: '上游渠道号', sortable: false, visible: true,width:280},
...
//                        console.log('');
            ...
            changePriceBut() {
                ...
                this.idList = [];
                for (let item of this.tableData) {
                    item.validStatus && item.validStatus != 'button' ? this.idList.push(item.channelProductCode) : null;
                }
