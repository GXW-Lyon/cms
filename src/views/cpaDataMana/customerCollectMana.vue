    ...
    export default {
        data() {
            return {
                ...
                checkedCities: ['客户名称', '产品名称', '账户余额'],
                cities: ['客户名称', '产品名称', '账户余额'],
                citiesImport: ['客户名称', '产品名称', '账户余额', '审批进度'],
                citiesFilterVal: ['entityCodeName', 'entityProductCodeName', 'balance', 'childNum'],
                table_column: [
                    {fixed: false, prop: 'entityCodeName', label: '客户名称', sortable: false, visible: true},
                ...
                table_column_bill_detail: [
                    ...
                    {fixed: false, prop: 'balance', label: '预收', sortable: false, visible: true},
                ...
                table_column_examine_progress: [
                    ...
                    {fixed: false, prop: 'customerName', label: '预收客户', sortable: false, visible: true},
                ...
                detailCities: ['日期', '客户名称', '产品名称', '预收', '来源', '我方主体'],
...
//                        console.log('');
            ...
            handleClick(tab, event) {
                if (this.activeName == '1') {
                    this.table_column_bill_detail[3].label = '预收';
            ...
            billImport() {
                ...
                let fileName = [this.customer_items.model_value, action, '明细'].join('_');
                this.handleDownload(tHeader, filterVal, importData, fileName);
            },
            examineProgress(arr){
