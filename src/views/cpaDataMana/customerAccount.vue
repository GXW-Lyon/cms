                ...
                <div class="f_i_date f_i_info">
                    <p style="display:inline-block;" v-for="(c, i) in financeData" :key="i">
                        ...
                        <span class="f_i_date_title f_i_info_long"><i class="moneyIcon"></i><span
                            class="span_margin">应收：<em>{{c.realtimeDataCost}}</em>元</span><span>实收：<em>{{c.customerCost}}</em>元</span></span>
                    </p>
                </div>
    ...
    export default {
        data() {
            return {
                ...
                checkedCities: ['客户名称', '账目周期', '应收款项', '实收款项', '支付状态', '备注'],
                cities: [ '对账日期','账目周期', '客户名称', '实际结算金额', '核减金额','应收款项', '实收款项', '支付状态', '备注'],
                ...
                table_column: [
                    ...
                    {fixed: false, prop: 'val_1', label: '应收款项', sortable: false, visible: true},
                    {fixed: false, prop: 'val_2', label: '实收款项', sortable: false, visible: true},
