<style rel="stylesheet/scss" lang="scss">
    .el-select .el-input .el-input__icon{top:50%!important;}
</style>
            ...
            <div class="page_d_con">
                <div class="page_d_con_left" style="width:600px">
                    <el-form ref="form" :model="template_from" label-width="125px">
                        ...
                        <!--<el-form-item label="上传落地页图片：" class="upload_img" v-if="lpFlag">-->
                            <!--<el-upload-->
                                <!--class="upload-demo"-->
                                <!--:data ="upLoadData1"-->
...
export default {
    ...
    methods: {
        ...
        onSubmit () {
            ...
            this.$http({
                method: 'post',
                url: this.apiUrl.tuiaAdminAdNew,
                data: {
        ...
        beforeAvatarUpload (file) {
            if(this.template_from.creativeTemplate==''){
                this.$message({
                    type: 'info',
                    message: '请先选择素材样式'
                });
